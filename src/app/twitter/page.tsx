...
export default function TwitterPage() {
  return (
    <DownloadApp
      platform="X / Twitter"
      platformColor="bg-gradient-to-br from-sky-500 to-sky-600"
      platformIcon="twitter"
      platformRegex="x\.com|twitter\.com"
      placeholder="https://x.com/user/status/..."
      title="X / Twitter Video İndirme"
      description="X/Twitter videolarini saniyeler içinde filigransiz indirin"
    />
  )
}
